...
class Median(data.Dataset):
    ...
    MedianClass = namedtuple('MedianClass', ['name', 'id', 'train_id', 'category', 'category_id',
                                                'has_instances', 'ignore_in_eval', 'color'])
    classes = [
        MedianClass('background', 0, 0, 'void', 0, False, True, (0, 0, 0)),
        MedianClass('nerve', 1, 1, 'void', 0, False, True, (0, 0, 255))
    ]
    ...
    def __init__(self, root, datatype='Median', image_set='train', transform=None, is_rgb=True):
        ...
        image_dir = os.path.join(self.root, datatype, 'Images')
        mask_dir = os.path.join(self.root, datatype,'Masks')
...
if __name__ == "__main__":
    ...
    for j in dlist:
        ...
        dst = Median(root='/data1/sdi/datasets', datatype=j, image_set='val',
